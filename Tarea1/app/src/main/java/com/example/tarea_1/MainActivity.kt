...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val botonIrRecyclerView = findViewById<Button>(R.id.bt_ir_recycler_view)
        botonIrRecyclerView.
                setOnClickListener {
                    abrirActiviad(ActividadRecyclerView::class.java)
                }

        val btn_ir_http = findViewById<Button>(R.id.btn_ir_http)
        btn_ir_http.setOnClickListener {
            abrirActiviad(UsarProtocoloHTTP::class.java)
        }
